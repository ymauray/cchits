    ...
    <div class="row FAQItem">
        <div class="col-12">
            ...
            <form action="{$baseURL}about/database" method="post">
                <input type="submit" name="go" value="Give me the database!" disabled="disabled"/>
                <p><small>Note : the export has been disabled because, amongst many other things, it contains some data we don't want to publish. Until we fix this issue, I'm afraid there is no way to get a dump of the database.</small></p>
            </form>
